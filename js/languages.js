var Languages = {
    ...
    Start: function(){
        ...
        $('#key option').eq(0).text(language.key_g);
        $('#key option').eq(1).text(language.key_c_1st_line);
        $('#key option').eq(2).text(language.key_c_2nd_line);
        $('#key option').eq(3).text(language.key_c_3rd_line);
        $('#key option').eq(4).text(language.key_c_4th_line);
        $('#key option').eq(5).text(language.key_f_3rd_line);
        $('#key option').eq(6).text(language.key_f_4th_line);
        $('#lang_ssl').html(language.ssl);
        $('#lang_lsl').html(language.lsl);
        $('#ssl option').eq(0).text(language.without_lines);
        $('#ssl option').eq(1).text(language.up_to_line_1);
        $('#ssl option').eq(2).text(language.up_to_line_2);
        $('#ssl option').eq(3).text(language.up_to_line_3);
        $('#ssl option').eq(4).text(language.up_to_line_4);
        $('#ssl option').eq(5).text(language.up_to_line_5);
        $('#lsl option').eq(0).text(language.without_lines);
        $('#lsl option').eq(1).text(language.up_to_line_1);
        $('#lsl option').eq(2).text(language.up_to_line_2);
        $('#lsl option').eq(3).text(language.up_to_line_3);
        $('#lsl option').eq(4).text(language.up_to_line_4);
        $('#lsl option').eq(5).text(language.up_to_line_5);          
        $('#lang_buttons').html(language.buttons);
        $('#buttons option').eq(0).text(language.notes_names);
        $('#buttons option').eq(1).text(language.key_letters);
